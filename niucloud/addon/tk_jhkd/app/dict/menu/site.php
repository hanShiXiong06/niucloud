...
return [
    [
        ...
        'children' => [
            [
                'menu_name' => '数据统计',
                'menu_key' => 'tk_jhkd_stat_index',
                'menu_short_name' => '数据',
                'parent_select_key' => '',
                'menu_type' => '1',
                'icon' => 'nc-iconfont nc-icon-wodetuiguangV6xx',
                'api_url' => '',
                'router_path' => 'tk_jhkd/stat/index',
            ...
            [
                'menu_name' => '添加优惠券',
                'menu_key' => 'tk_jhkd_coupon_add',
                'menu_short_name' => '添加优惠券',
                'parent_select_key' => '',
                'menu_type' => '1',
                'icon' => 'nc-iconfont nc-icon-fenxiaoV6xx1',
                'api_url' => '',
                'router_path' => 'tk_jhkd/coupon/add',
                'view_path' => 'coupon/add',
                'methods' => 'post',
                'sort' => '0',
                'status' => '1',
                'is_show' => '0',
            ...
            [
                'menu_name' => '编辑优惠券',
                'menu_key' => 'tk_jhkd_coupon_edit',
                'menu_short_name' => '编辑优惠券',
                'parent_select_key' => '',
                'menu_type' => '1',
                'icon' => 'nc-iconfont nc-icon-sousuo-duanV6xx',
                'api_url' => '',
                'router_path' => 'tk_jhkd/coupon/edit',
                'view_path' => 'coupon/edit',
                'methods' => 'post',
                'sort' => '0',
                'status' => '1',
                'is_show' => '0',
            ...
            [
                'menu_name' => '优惠券',
                'menu_key' => 'tk_jhkd_coupon',
                'menu_short_name' => '优惠券',
                'parent_select_key' => '',
                'menu_type' => '1',
                'icon' => 'nc-iconfont nc-icon-youhuiquanV6xx-1',
                'api_url' => '',
                'router_path' => 'tk_jhkd/coupon/list',
                'view_path' => 'coupon/list',
                'methods' => 'post',
                'sort' => '0',
                'status' => '1',
                'is_show' => '1',
