...
import { getCouponList, deleteCoupon, closeCoupon, getCouponStatusList } from '@/addon/home_service/api/marketing'
import { ElMessageBox, FormInstance } from 'element-plus'
import { t } from '@/lang'
import { setTablePageStorage, getTablePageStorage } from '@/utils/common'
import couponCollection from '@/addon/home_service/views/marketing/coupon/components/coupon-collection.vue'
import CouponSendRecords from '@/addon/home_service/views/marketing/coupon/components/coupon-send-records.vue'
import couponSendPopup from '@/addon/home_service/views/marketing/coupon/components/coupon-send-popop.vue'
...
const spreadEvent = (data: any) => {
    const pagePath = '/addon/home_service/pages/coupon/detail'
    const paramsArr = [
...
// 添加优惠券
const handleChange = () => {
    router.push('/home_service/marketing/coupon/add')
}
// 编辑优惠券
const editEvent = (data: any) => {
    router.push('/home_service/marketing/coupon/edit?id=' + data.id)
}
