...
<script setup lang="ts">
	...
	import { getCashOutList } from '@/addon/home_service/store/api/member';
	...
	const toDetailFn = (data : any) => {
		redirect({ url: '/addon/home_service/store/pages/member/cash/cash_out_detail', param: { id: data.id } });
	}
</script>
