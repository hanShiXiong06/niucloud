<template>
    <view class="w-screen h-screen flex flex-col"  :style="'background:url('+img('addon/home_service/store/auth/store_auth_background.png')+');background-size: 100% 100%;'" v-if="type">
        ...
        <view class="mx-[60rpx]">
            ...
            <!-- <view class="w-[88rpx] h-[88rpx] bg-[#EDF2FF] rounded-[12rpx] mt-[140rpx] flex items-center justify-center">
                <image
                    :src="img('addon/home_service/technician/auth/technician_ico.png')"
                    mode="scaleToFill"
                    class="w-[56rpx] h-[56rpx]"
                />
             </view>
            <view class="pt-[30rpx] text-[48rpx] font-500 text-[#111] leading-[normal]">
                您好，
            </view>
            ...
            <view class="pt-[30rpx] text-[42rpx] font-500 text-[#111] leading-[normal] mt-[100rpx] mb-[60rpx]">
                欢迎注册
            </view>
            <u-form labelPosition="left" :model="formData" errorType='toast' :rules="rules" ref="formRef">
                <template v-if="type == 'username'">
                    <view class="px-[30rpx] flex items-center" >
                        ...
                        <text class="text-[#111] text-[30rpx] ml-[19rpx] leading-[normal]">账号</text>
                    </view>
                    <view class="h-[88rpx] flex w-full items-center px-[30rpx]   box-border bg-[rgb(255,255,255,0)]" style="border-bottom: 1px solid #CCCCCC;">
                      ...
                      <view class="px-[30rpx] flex items-center mt-[50rpx]">
                        <image :src="img('addon/home_service/store/auth/password.png')" mode="scaleToFill"
                            class="w-[34rpx] h-[34rpx]" />
                        <text class="text-[#111] text-[30rpx] ml-[19rpx] leading-[normal]">密码</text>
                    </view>
                    <view class="h-[88rpx] flex w-full items-center px-[30rpx]   box-border bg-[rgb(255,255,255,0)]" style="border-bottom: 1px solid #CCCCCC;">
                ...
                <template v-if="type == 'mobile' || configStore.login.is_bind_mobile">
                    ...
                    <view class="h-[88rpx] flex w-full items-center px-[30rpx]   box-border bg-[rgb(255,255,255,0)]" style="border-bottom: 1px solid #CCCCCC;">
                      ...
                      <view class="px-[30rpx] flex items-center mt-[50rpx]">
                        <image :src="img('addon/home_service/store/auth/safety.png')" mode="scaleToFill"
                            class="w-[34rpx] h-[34rpx]" />
                        <text class="text-[#111] text-[30rpx] ml-[19rpx] leading-[normal]">验证码</text>
                    </view>
                    <view class="h-[88rpx] flex w-full items-center px-[30rpx]   box-border bg-[rgb(255,255,255,0)]" style="border-bottom: 1px solid #CCCCCC;">
            ...
            <view class="mt-[110rpx]">
                <view v-if="configStore.login.agreement_show" class="flex items-center mt-[10rpx] mb-[20rpx] py-[14rpx]" @click.stop="agreeChange">
                    <u-checkbox-group @change="agreeChange">
                        <u-checkbox activeColor="var(--store-bg-one)" :checked="isAgree" shape="circle" size="24rpx" />
                    </u-checkbox-group>
                    <view class="text-[24rpx] -ml-[4rpx] text-[var(--text-color-light6)] flex items-center flex-wrap leading-[30rpx]">
                        <text>{{ t('agreeTips') }}</text>
                        <text @click.stop="redirect({ url: '/app/pages/auth/agreement?key=store_privacy' })" class="text-[var(--store-bg-one)]">《{{ t('privacyAgreement') }}》</text>
                        <text>{{ t('and') }}</text>
                        <text @click.stop="redirect({ url: '/app/pages/auth/agreement?key=store_register' })" class="text-[var(--store-bg-one)]">《{{ t('userAgreement') }}》</text>
                    </view>
                </view>
...
import { redirect, getToken, pxToRpx ,img} from '@/utils/common'
import { onLoad } from '@dcloudio/uni-app';
import { topTabar } from '@/utils/topTabbar'
import useSystemStore from "@/stores/system";
import smsCode from '@/addon/home_service/store/components/sms-code/sms-code.vue'
