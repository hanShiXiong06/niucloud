		...
		<view class="diy-o2o-search relative overflow-hidden flex items-center">
			<template  v-if="diyComponent.style == 'style1'">
				<view class="flex-1 flex items-center py-[12rpx] px-[30rpx] justify-between input-class" :style="{
					...
					<up-input v-model="searchName" border="none" :placeholder="diyComponent.search_text"  :color="diyComponent.text_color"
					:placeholderStyle='{color:diyComponent.text_color}' fontSize="24rpx"></up-input>
			...
			<template v-if="diyComponent.style == 'style2'">
				<view class="flex-1 flex items-center py-[12rpx] px-[30rpx] justify-between " :style="{
					...
					<up-input v-model="searchName" border="none" :placeholder="diyComponent.search_text"
					:placeholderStyle='{color:diyComponent.text_color}' :color="diyComponent.text_color" fontSize="24rpx"></up-input>
