<template>
    <view class="text-[26rpx]" :class="{'text-[var(--technician-bg-one)]': sendSms.canGetCode.value, 'text-gray-300': !sendSms.canGetCode.value}" @click="handleSend">{{ sendSms.tips.value }}</view>
