...
return [
    'home_service_buy_goods' => [
        'key' => 'home_service_buy_goods',
        'name' => '购买项目',
        'desc' => '订单交易成功后按订单交易金额发放成长值',
        'component' => '/src/addon/home_service/views/member/components/growth-rule-buygoods.vue',
        ...
        'content' => [
            ...
            'task' => function($site_id, $config) {
                return [
                    'icon' => '/addon/home_service/rule/growth-rule-cart.png',
                    'title' => '购买项目',
                    'desc' => "购买项目可获得{$config['growth']}成长值/{$config['money']}元",
                    'button' => [
                        'text' => '去购买',
                        'wap_redirect' => '/addon/home_service/user/pages/index'
                    ]
                ];
            }
        ]
    ],
    'home_service_buy_order' => [
        'key' => 'home_service_buy_order',
        'name' => '完成下单',
        'desc' => '订单交易成功后发放成长值',
        'component' => '/src/addon/home_service/views/member/components/growth-rule-buyorder.vue',
        ...
        'content' => [
            ...
            'task' => function($site_id, $config) {
                return [
                    'icon' => '/addon/home_service/rule/growth-rule-buy.png',
                    'title' => '完成下单',
