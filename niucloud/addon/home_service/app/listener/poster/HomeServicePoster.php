        ...
        if ($type == 'home_service_goods') {
            ...
            if ($mode == 'preview') {
                ...
                $return_data = [
                    ...
                    'goods_name' => '项目名称',
                    'goods_price' => '￥369.00',
                    'goods_img' => 'addon/home_service/goods_template.png',
                    'url' => [
                        'url' => ( new CoreSysConfigService() )->getSceneDomain($site_id)[ 'wap_url' ],
                        'page' => 'addon/home_service/pages/goods/detail',
                        'data' => $url_data,
                    ],
                ];
                return $return_data;
            ...
            if (empty($sku_img)) {
                $sku_img = 'addon/home_service/goods_template.png';
            }
            $url_data = [
                [ 'key' => 'sku_id', 'value' => $sku_id ]
            ];
            ...
            $return_data = [
                ...
                'url' => [
                    'url' => ( new CoreSysConfigService() )->getSceneDomain($site_id)[ 'wap_url' ],
                    'page' => 'addon/home_service/user/pages/goods/detail',
                    'data' => $url_data,
                ],
            ];
