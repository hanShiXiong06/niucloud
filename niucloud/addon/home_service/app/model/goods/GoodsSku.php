 ...
 * 商品规格模型
 * Class GoodsSku
 * @package addon\home_service\app\model\goods_sku
 */
class GoodsSku extends BaseModel
{
     ...
     * @var string
     */
    protected $name = 'home_service_goods_sku';
    ...
    public function goods()
    {
        return $this->hasOne(Goods::class, 'goods_id', 'goods_id')
            ->joinType('left')
            ->withField('top_category,goods_subtitle,goods_id, poster_id, member_discount, site_id, goods_name, goods_cover, goods_image, sale_num + virtually_sale as sale_num, status, goods_category,after_sales,buy_type,price_list,goods_content,buy_info,is_force_clock_in,is_force_departure,grab_orders,is_finish_photograph,guarantee_id')
