...
class GoodsCategoryService extends BaseApiService
{
    ...
    public function getInfo(int $id)
    {
        ...
        $info = $this->model->field($field)->where([['category_id', '=', $id], ['site_id', '=', $this->site_id]])->findOrEmpty()->append(['image_thumb_small', 'image_thumb_mid'])->toArray();
        return $info;
    }
    ...
    public function getTree()
    {
        $list = $this->model
            ...
            ->field('category_id,category_name,image,pid,site_id,sort,adv_image,errand_business')
