<template>
    <div class="recycle-category">
        ...
        <el-card shadow="never">
            ...
            <el-tabs class="demo-tabs" model-value="/recycle/goods/category" @tab-change="handleClick">
                <el-tab-pane :label="t('报价分类')" name="/recycle/goods/category" />
                                    ...
                                    <template #error>
                                        <div class="image-slot">
                                            <img class="w-[30px] h-[30px]"
                                                src="@/addon/recycle/assets/category_default.png" />
                                        </div>
                                    </template>
                                </el-image>
                            </div>
...
import { t } from '@/lang'
// import { updateCategory, editCategory } from '@/addon/recycle/api/goods'

import { getCategoryTree, deleteRecycleCategory, editRecycleCategory, updateRecycleCategory } from '@/addon/recycle/api/recycle_category'

import { img } from '@/utils/common'
import { ElMessageBox } from 'element-plus'
import categoryEdit from '@/addon/recycle/views/recycle_category/components/recycle-category-edit.vue'
