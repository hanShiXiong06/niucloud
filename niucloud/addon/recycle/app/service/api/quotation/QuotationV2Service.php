...
use addon\recycle\app\service\core\quotation\QuotationDisplayConfigService;
...
class QuotationV2Service extends BaseApiService
{
    public function getTypes(array $where = []): array
    {
        ...
        ])->field('id,quotation_id,price_name,dataset_name,channel_key,sort,last_sync_at,last_sync_status,last_sync_message,last_sync_summary,remark,update_at')
