...
class Test extends BaseAdminController
{
    /**
     * 测试所有服务
     * 访问地址: /admin/recycle/third_party.test/testAll
     */
    ...
    /**
     * 测试设备查询
     * 访问地址: /admin/recycle/third_party.test/testDeviceQuery
     */
    ...
    /**
     * 测试快递查询
     * 访问地址: /admin/recycle/third_party.test/testExpressQuery
     */
    ...
    /**
     * 健康检查
     * 访问地址: /admin/recycle/third_party.test/healthCheck
     */
    ...
    /**
     * 查看API调用日志
     * 访问地址: /admin/recycle/third_party.test/apiLogs
     */
    public function apiLogs()
    {
        $limit = $this->request->param('limit', 20);

        $logs = \addon\recycle\app\model\third_party\ThirdPartyApiLog::where('site_id', $this->site_id)
    ...
    /**
     * 查看费用统计
     * 访问地址: /admin/recycle/third_party.test/costStats
     */
    public function costStats()
    {
        $stats = \addon\recycle\app\model\third_party\ThirdPartyCostStats::where('site_id', $this->site_id)
            ->order('date', 'desc')
            ->select()
            ->toArray();
