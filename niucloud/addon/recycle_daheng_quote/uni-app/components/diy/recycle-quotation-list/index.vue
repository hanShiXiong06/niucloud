                ...
                <view v-else-if="displayStyle === 'graphic'" class="quotation-nav">
                    ...
                    >
                        <view
                            ...
                            :style="navImageStyle"
                        >
                            <image :src="img(resolveDatasetImage(item))" mode="aspectFill"></image>
                        </view>
...
function resolveDatasetImage(item: QuotationV2Type & { nav_image?: string }) {
    return item.nav_image || 'static/resource/images/diy/figure.png';
}
