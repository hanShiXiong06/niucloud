...
final class Order extends BaseAdminController
{
    ...
    public function create() { return success((new MemberCardOrderService())->create($this->request->params([['request_id', ''], ['member_id', 0], ['product_id', 0], ['bind_imei', ''], ['bind_model', ''], ['settlement_mode', 'receivable'], ['capital_account_id', 0], ['voucher_urls', []], ['remark', '']]))); }
