...
final class Card extends BaseAdminController
{
    ...
    public function redeem(int $id) { return success((new MemberCardRedemptionService())->redeem($id, $this->request->params([['request_id', ''], ['card_item_id', 0], ['service_imei', ''], ['service_model', ''], ['verification_confirmed', 0], ['actual_consumable_qty', null], ['remark', '']]))); }
