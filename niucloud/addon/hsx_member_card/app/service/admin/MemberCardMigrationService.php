        ...
        Db::transaction(function () use (
            ...
            if ($card === null || $card->isEmpty()) {
                ...
                MemberCardItem::create([
                    ...
                    'consumable_code' => (string)($productItem->consumable_code ?? ''),
                    'consumable_name' => (string)($productItem->consumable_name ?? ''),
                    'consumable_unit' => (string)($productItem->consumable_unit ?? '张'),
                    'standard_consumable_qty' => (float)($productItem->standard_consumable_qty ?? 0),
                    'status' => 1,
                    'create_at' => $createdAt,
                    'update_at' => time(),
                ]);
