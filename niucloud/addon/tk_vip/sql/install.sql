...
-- ----------------------------
-- Table structure for {{prefix}}tkvip_fenxiao_member
-- ----------------------------
DROP TABLE IF EXISTS `{{prefix}}tkvip_fenxiao_member`;
CREATE TABLE `{{prefix}}tkvip_fenxiao_member`
(
...
-- ----------------------------
-- Table structure for {{prefix}}tkvip_fenxiao_order
-- ----------------------------
DROP TABLE IF EXISTS `{{prefix}}tkvip_fenxiao_order`;
CREATE TABLE `{{prefix}}tkvip_fenxiao_order`
(
