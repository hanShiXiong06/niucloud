...
Route::group('tk_vip', function() {
    /***************************************************** vip 登录接口 ****************************************************/
    Route::get('getconfig', 'addon\tk_vip\app\api\controller\config\Config@getConfig');
    ...
    //分销绑定
    Route::post('checkfenxiao', 'addon\tk_vip\app\api\controller\fenxiao\Fenxiao@checkFenxiao');
    //统计分销订单
    Route::get('fenxiao/getfenxiaofnfo', 'addon\tk_vip\app\api\controller\fenxiao\Fenxiao@getFenxiaoInfo');
    //2.0分销订单统计
    Route::get('fenxiao/getorderdata', 'addon\tk_vip\app\api\controller\fenxiao\Fenxiao@getOrderData');
    //分销会员统一入口
    Route::get('fenxiao/getfenxiaomember', 'addon\tk_vip\app\api\controller\fenxiao\Fenxiao@getFenxiaoMember');
    //订单统一入口
    Route::get('fenxiao/getfenxiaoorder', 'addon\tk_vip\app\api\controller\fenxiao\Fenxiao@getFenxiaoOrder');
    Route::get('fenxiao/getselffenxiaoorder', 'addon\tk_vip\app\api\controller\fenxiao\Fenxiao@getSelfFenxiaoOrder');
