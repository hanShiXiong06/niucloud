...
Route::group('sd_xiaoyuan', function () {
    ...
    Route::group('order', function () {
        ...
        Route::post('confirm_complete', 'addon\sd_xiaoyuan\app\adminapi\controller\Order@confirmComplete');
    ...
    Route::group('runner', function () {
        ...
        Route::post('set_can_jiedan', 'addon\sd_xiaoyuan\app\adminapi\controller\Runner@setCanJiedan');
        Route::post('delete', 'addon\sd_xiaoyuan\app\adminapi\controller\Runner@delete');
    });
    ...
    Route::group('service_card', function () {
        Route::get('list', 'addon\sd_xiaoyuan\app\adminapi\controller\ServiceCard@lists');
        Route::post('save', 'addon\sd_xiaoyuan\app\adminapi\controller\ServiceCard@save');
    });

    Route::group('card_order', function () {
        Route::get('list', 'addon\sd_xiaoyuan\app\adminapi\controller\CardOrder@lists');
    });
    ...
    Route::group('secondhand', function () {
        ...
        Route::post('audit', 'addon\sd_xiaoyuan\app\adminapi\controller\Secondhand@audit');
        Route::post('edit', 'addon\sd_xiaoyuan\app\adminapi\controller\Secondhand@edit');
        Route::post('delete', 'addon\sd_xiaoyuan\app\adminapi\controller\Secondhand@delete');
    });
    ...
    Route::group('lost_found', function () {
        ...
        Route::post('audit', 'addon\sd_xiaoyuan\app\adminapi\controller\LostFound@audit');
        Route::post('delete', 'addon\sd_xiaoyuan\app\adminapi\controller\LostFound@delete');
    });
    ...
    // 包裹规格管理
    Route::group('package_price', function () {
        Route::get('list', 'addon\sd_xiaoyuan\app\adminapi\controller\PackagePrice@lists');
        Route::get('info/:id', 'addon\sd_xiaoyuan\app\adminapi\controller\PackagePrice@info');
        Route::post('add', 'addon\sd_xiaoyuan\app\adminapi\controller\PackagePrice@add');
        Route::post('edit/:id', 'addon\sd_xiaoyuan\app\adminapi\controller\PackagePrice@edit');
        Route::delete('del/:id', 'addon\sd_xiaoyuan\app\adminapi\controller\PackagePrice@del');
    });
