...
class SecondhandService extends BaseApiService
{
    ...
    {
        $field = 'id,site_id,member_id,school_id,campus,category_id,title,images,original_price,price,condition_level,trade_method,view_count,want_count,status,is_top,create_time';
    ...
    public function del(int $id, int $member_id)
    {
        ...
        $goods->save(['status' => Secondhand::STATUS_DELETED, 'update_time' => time()]);
        return true;
    }
