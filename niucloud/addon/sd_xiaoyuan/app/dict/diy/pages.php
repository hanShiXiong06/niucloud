...
return [
                ...
                'value' => [
                    ...
                    [
                        ...
                        'list' => [
                            ...
                            ['name' => '约伴组局', 'icon' => 'account', 'iconColor' => '#2f8f83', 'bgColor' => '#e6fffb', 'imageUrl' => '', 'url' => '/addon/sd_xiaoyuan/pages/companion/create', 'link' => ['name' => 'SD_XIAOYUAN_COMPANION_CREATE', 'title' => '约伴组局', 'url' => '/addon/sd_xiaoyuan/pages/companion/create', 'parent' => 'SD_XIAOYUAN_LINK'], 'isShow' => true]
                        ],
                        'pageStartBgColor' => '',
                        'pageEndBgColor' => '',
                        'pageGradientAngle' => 'to bottom',
                    ...
                    [
                        ...
                        'uses' => 1,
                        'id' => 'xiaoyuan_community_1',
                        'componentName' => 'XiaoyuanCommunity',
                        'componentTitle' => '校园树洞',
                        'title' => '校园树洞',
                        'showMore' => true,
                        'moreText' => '查看更多',
                    ...
                    [
                        ...
                        'uses' => 1,
                        'id' => 'xiaoyuan_idle_preview_1',
                        'componentName' => 'XiaoyuanIdlePreview',
                        'componentTitle' => '闲置好物',
                        'title' => '闲置好物',
                        'showMore' => true,
                        'moreText' => '查看更多',
                        'moreUrl' => [
                            'name' => 'SD_XIAOYUAN_SECONDHAND_INDEX',
                            'title' => '闲置市场',
    ...
    'DIY_SD_XIAOYUAN_MEMBER' => [
        'sd_xiaoyuan_member_default' => [
            'title' => '校园帮个人中心',
            'cover' => '',
            'preview' => '',
            'desc' => '校园帮个人中心默认模板',
            ...
            'data' => [
                ...
                'value' => include __DIR__ . '/pages_member_default.php',
            ]
        ]
    ]
];
