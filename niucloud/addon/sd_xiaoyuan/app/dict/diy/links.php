...
return [
    'SD_XIAOYUAN_LINK' => [
        ...
        'child_list' => [
            ...
            // [
            //     'name' => 'SD_XIAOYUAN_DIYINDEX',
            //     'title' => '校园帮',
            //     'url' => '/addon/sd_xiaoyuan/pages/index/diy',
            //     'is_share' => 1,
            //     'action' => ''
            // ],
            [
            ...
            [
                'name' => 'SD_XIAOYUAN_SECONDHAND_MY',
                'title' => '我的二手',
                'url' => '/addon/sd_xiaoyuan/pages/secondhand/index',
                'is_share' => 0,
                'action' => ''
            ...
            [
                'name' => 'SD_XIAOYUAN_PARTTIME_CREATE',
                'title' => '兼职招聘',
                'url' => '/addon/sd_xiaoyuan/pages/parttime/create',
                'is_share' => 0,
                'action' => ''
            ],
            [
                'name' => 'SD_XIAOYUAN_COMPANION_CREATE',
                'title' => '约伴组局',
                'url' => '/addon/sd_xiaoyuan/pages/companion/create',
                'is_share' => 0,
                'action' => ''
            ],
            [
