            ...
            'XiaoyuanMenuGrid' => [
                ...
                'value' => [
                    ...
                    'list' => [
                        ...
                        ['name' => '兼职招聘', 'icon' => 'account-fill', 'iconColor' => '#6a5acd', 'bgColor' => '#f3f0ff', 'url' => '/addon/sd_xiaoyuan/pages/parttime/create', 'isShow' => true],
                        ['name' => '约伴组局', 'icon' => 'people-fill', 'iconColor' => '#2f8f83', 'bgColor' => '#e6fffb', 'url' => '/addon/sd_xiaoyuan/pages/companion/create', 'isShow' => true]
                    ]
                ],
                'template' => [
                    'textColor' => '#303133',
