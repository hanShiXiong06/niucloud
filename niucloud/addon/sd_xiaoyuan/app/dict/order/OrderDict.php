...
class OrderDict
{
    ...
    const STATUS_WAIT_USER_CONFIRM = 45;
    ...
    const TASK_TYPE_PARTTIME = 'PARTTIME';
    const TASK_TYPE_COMPANION = 'COMPANION';
    ...
    public static function getStatus()
    {
        return [
            ...
            self::STATUS_WAIT_USER_CONFIRM => '用户确认',
    ...
    public static function getTaskType()
    {
        return [
            ...
            self::TASK_TYPE_PARTTIME => '兼职招聘',
            self::TASK_TYPE_COMPANION => '约伴组局'
        ];
    }
}
