...
-- ----------------------------
-- Table structure for niu_xiaoyuan_address
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_address`;
CREATE TABLE `niu_xiaoyuan_address`  (
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_appeal
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_appeal`;
CREATE TABLE `niu_xiaoyuan_appeal`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_campus
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_campus`;
CREATE TABLE `niu_xiaoyuan_campus`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_campus_auth
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_campus_auth`;
CREATE TABLE `niu_xiaoyuan_campus_auth`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
  `member_id` int(11) NOT NULL DEFAULT 0 COMMENT '会员ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_comment
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_comment`;
CREATE TABLE `niu_xiaoyuan_comment`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_community
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_community`;
CREATE TABLE `niu_xiaoyuan_community`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_community_category
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_community_category`;
CREATE TABLE `niu_xiaoyuan_community_category`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_community_comment
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_community_comment`;
CREATE TABLE `niu_xiaoyuan_community_comment`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_complaint
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_complaint`;
CREATE TABLE `niu_xiaoyuan_complaint`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_confession
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_confession`;
CREATE TABLE `niu_xiaoyuan_confession`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
  `member_id` int(11) NOT NULL DEFAULT 0 COMMENT '发布者ID',
  `school_id` int(11) NOT NULL DEFAULT 0 COMMENT '学校ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_confession_comment
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_confession_comment`;
CREATE TABLE `niu_xiaoyuan_confession_comment`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0,
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_coupon
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_coupon`;
CREATE TABLE `niu_xiaoyuan_coupon`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_coupon_record
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_coupon_record`;
CREATE TABLE `niu_xiaoyuan_coupon_record`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_credit
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_credit`;
CREATE TABLE `niu_xiaoyuan_credit`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_credit_log
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_credit_log`;
CREATE TABLE `niu_xiaoyuan_credit_log`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
  `member_id` int(11) NOT NULL DEFAULT 0 COMMENT '用户ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_escrow
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_escrow`;
CREATE TABLE `niu_xiaoyuan_escrow`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_evaluate
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_evaluate`;
CREATE TABLE `niu_xiaoyuan_evaluate`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
  `order_id` int(11) NOT NULL DEFAULT 0 COMMENT '订单ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_express_station
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_express_station`;
CREATE TABLE `niu_xiaoyuan_express_station`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0,
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_game_category
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_game_category`;
CREATE TABLE `niu_xiaoyuan_game_category`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_game_companion
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_game_companion`;
CREATE TABLE `niu_xiaoyuan_game_companion`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0,
  `member_id` int(11) NOT NULL DEFAULT 0,
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_group_member
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_group_member`;
CREATE TABLE `niu_xiaoyuan_group_member`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_group_order
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_group_order`;
CREATE TABLE `niu_xiaoyuan_group_order`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_house
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_house`;
CREATE TABLE `niu_xiaoyuan_house`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
  `member_id` int(11) NOT NULL DEFAULT 0 COMMENT '发布者ID',
  `school_id` int(11) NOT NULL DEFAULT 0 COMMENT '学校ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_house_order
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_house_order`;
CREATE TABLE `niu_xiaoyuan_house_order`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0,
  `member_id` int(11) NOT NULL DEFAULT 0,
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_lost_found
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_lost_found`;
CREATE TABLE `niu_xiaoyuan_lost_found`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
  `member_id` int(11) NOT NULL DEFAULT 0 COMMENT '发布者ID',
  `school_id` int(11) NOT NULL DEFAULT 0 COMMENT '发布人学校ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_lost_found_category
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_lost_found_category`;
CREATE TABLE `niu_xiaoyuan_lost_found_category`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '分类名称',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_member_relation
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_member_relation`;
CREATE TABLE `niu_xiaoyuan_member_relation`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
  `member_id` int(11) NOT NULL DEFAULT 0 COMMENT '用户ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_message
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_message`;
CREATE TABLE `niu_xiaoyuan_message`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_order
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_order`;
CREATE TABLE `niu_xiaoyuan_order`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
  ...
  `campus` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '发布人校区',
  `task_type` enum('EXPRESS','BUY','ERRAND','QUEUE','PRINT','SEAT','GAME','CLEAN','TRASH','CARRY','HELP','GROUP') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '任务类型:EXPRESS代取快递,BUY代买,ERRAND跑腿,QUEUE代排队,PRINT代打印,SEAT代占座,GAME游戏陪练,CLEAN代清洁,TRASH代倒垃圾,CARRY代搬运,HELP帮帮忙,GROUP组队',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_order_log
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_order_log`;
CREATE TABLE `niu_xiaoyuan_order_log`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `order_id` int(11) NOT NULL DEFAULT 0 COMMENT '订单ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_package_price
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_package_price`;
CREATE TABLE `niu_xiaoyuan_package_price`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0,
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_points_exchange
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_points_exchange`;
CREATE TABLE `niu_xiaoyuan_points_exchange`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_points_goods
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_points_goods`;
CREATE TABLE `niu_xiaoyuan_points_goods`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_points_goods_category
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_points_goods_category`;
CREATE TABLE `niu_xiaoyuan_points_goods_category`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '分类名称',
  `icon` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '分类图标',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_points_order
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_points_order`;
CREATE TABLE `niu_xiaoyuan_points_order`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_runner
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_runner`;
CREATE TABLE `niu_xiaoyuan_runner`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
  `member_id` int(11) NOT NULL DEFAULT 0 COMMENT '会员ID',
  `real_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '真实姓名',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_runner_balance_log
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_runner_balance_log`;
CREATE TABLE `niu_xiaoyuan_runner_balance_log`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
  `runner_id` int(11) NOT NULL DEFAULT 0 COMMENT '跑腿员ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_runner_level
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_runner_level`;
CREATE TABLE `niu_xiaoyuan_runner_level`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
  ...
  `commission_rate` tinyint(3) NOT NULL DEFAULT 70 COMMENT '佣金比例(%)',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_runner_location
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_runner_location`;
CREATE TABLE `niu_xiaoyuan_runner_location`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_schedule
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_schedule`;
CREATE TABLE `niu_xiaoyuan_schedule`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
  `member_id` int(11) NOT NULL DEFAULT 0 COMMENT '用户ID',
  `school_id` int(11) NOT NULL DEFAULT 0 COMMENT '学校ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_schedule_setting
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_schedule_setting`;
CREATE TABLE `niu_xiaoyuan_schedule_setting`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
  `member_id` int(11) NOT NULL DEFAULT 0 COMMENT '用户ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_school
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_school`;
CREATE TABLE `niu_xiaoyuan_school`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_secondhand
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_secondhand`;
CREATE TABLE `niu_xiaoyuan_secondhand`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
  `member_id` int(11) NOT NULL DEFAULT 0 COMMENT '发布者ID',
  `school_id` int(11) NOT NULL DEFAULT 0 COMMENT '发布人学校ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_secondhand_category
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_secondhand_category`;
CREATE TABLE `niu_xiaoyuan_secondhand_category`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '分类名称',
  `icon` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '分类图标',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_secondhand_want
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_secondhand_want`;
CREATE TABLE `niu_xiaoyuan_secondhand_want`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
  `goods_id` int(11) NOT NULL DEFAULT 0 COMMENT '商品ID',
  `member_id` int(11) NOT NULL DEFAULT 0 COMMENT '用户ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_sign
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_sign`;
CREATE TABLE `niu_xiaoyuan_sign`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
  `member_id` int(11) NOT NULL DEFAULT 0 COMMENT '用户ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_sign_config
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_sign_config`;
CREATE TABLE `niu_xiaoyuan_sign_config`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_task
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_task`;
CREATE TABLE `niu_xiaoyuan_task`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_tip_order
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_tip_order`;
CREATE TABLE `niu_xiaoyuan_tip_order`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
...
-- ----------------------------
-- Table structure for niu_xiaoyuan_vip
-- ----------------------------
DROP TABLE IF EXISTS `niu_xiaoyuan_vip`;
CREATE TABLE `niu_xiaoyuan_vip`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
  `member_id` int(11) NOT NULL DEFAULT 0 COMMENT '会员ID',
