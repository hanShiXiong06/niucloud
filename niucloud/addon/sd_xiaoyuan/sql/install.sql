/*
 ...
 Source Schema         : niuaddon10

 Target Server Type    : MySQL
 Target Server Version : 50726 (5.7.26)
 File Encoding         : 65001

 Date: 02/06/2026 13:40:02
*/
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '常用地址表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '校园认证表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for {{prefix}}xiaoyuan_card_order
-- ----------------------------
DROP TABLE IF EXISTS `{{prefix}}xiaoyuan_card_order`;
CREATE TABLE `{{prefix}}xiaoyuan_card_order`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0,
  `member_id` int(11) NOT NULL DEFAULT 0,
  `card_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `card_id` int(11) NOT NULL DEFAULT 0,
  `runner_id` int(11) NOT NULL DEFAULT 0,
  `order_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  ...
  INDEX `idx_runner`(`runner_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '次卡订单' ROW_FORMAT = Dynamic;
...
CREATE TABLE `{{prefix}}xiaoyuan_class`  (
  ...
  INDEX `site_id`(`site_id`, `status`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 298 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '班级表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 3653 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '班级课表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'community comments' ROW_FORMAT = Dynamic;
...
CREATE TABLE `{{prefix}}xiaoyuan_community_like`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `unique_like`(`site_id`, `member_id`, `post_id`) USING BTREE,
  INDEX `idx_post_id`(`post_id`) USING BTREE,
  INDEX `idx_member_id`(`member_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '社区帖子点赞记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `{{prefix}}xiaoyuan_confession`  (
  ...
  INDEX `site_id`(`site_id`, `status`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 21 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '表白墙表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `{{prefix}}xiaoyuan_confession_like`  (
  ...
  `create_time` int(11) NOT NULL DEFAULT 0 COMMENT '点赞时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `unique_like`(`site_id`, `member_id`, `confession_id`) USING BTREE,
  INDEX `idx_confession_id`(`confession_id`) USING BTREE,
  INDEX `idx_member_id`(`member_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '表白墙点赞记录表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户信誉分表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `{{prefix}}xiaoyuan_credit_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `member_id`(`member_id`, `site_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '信誉分变动记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `{{prefix}}xiaoyuan_house`  (
  ...
  `nearby_schools` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '附近学校ID(JSON数组)',
  `facilities` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '配套设施(JSON数组)',
...
CREATE TABLE `{{prefix}}xiaoyuan_lost_found`  (
  ...
  `contact_wechat` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '联系微信',
...
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '失物招领表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for {{prefix}}xiaoyuan_member_card
-- ----------------------------
DROP TABLE IF EXISTS `{{prefix}}xiaoyuan_member_card`;
CREATE TABLE `{{prefix}}xiaoyuan_member_card`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0,
  `member_id` int(11) NOT NULL DEFAULT 0,
  `card_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  ...
  `update_time` int(11) NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `site_member_card`(`site_id`, `member_id`, `card_type`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '会员次卡' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 72 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统消息表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 48 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '校园帮订单表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `{{prefix}}xiaoyuan_package_price`  (
  ...
  `create_time` int(11) NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '包裹规格价格表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '跑腿员表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 46 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '接单员等级配置表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '课表表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `{{prefix}}xiaoyuan_school`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `site_id`(`site_id`, `status`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '学校表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `{{prefix}}xiaoyuan_secondhand`  (
  ...
  INDEX `school_id`(`school_id`, `campus`, `status`) USING BTREE,
  INDEX `category_id`(`category_id`, `status`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '二手交易表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for {{prefix}}xiaoyuan_service_card
-- ----------------------------
DROP TABLE IF EXISTS `{{prefix}}xiaoyuan_service_card`;
CREATE TABLE `{{prefix}}xiaoyuan_service_card`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `site_id` int(11) NOT NULL DEFAULT 0,
  `card_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `subtitle` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `price` decimal(10, 2) NOT NULL DEFAULT 0.00,
  ...
  `update_time` int(11) NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `site_card_type`(`site_id`, `card_type`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '次卡配置' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '签到记录表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '签到配置表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `{{prefix}}xiaoyuan_tip_order`  (
  ...
  INDEX `idx_member`(`member_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '打赏订单表' ROW_FORMAT = Dynamic;
