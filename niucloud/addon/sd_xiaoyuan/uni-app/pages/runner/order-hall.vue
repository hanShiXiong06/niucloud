<template>
    <view class="order-hall">
        ...
        <view class="filter-bar">
            ...
            <view class="filter-item" :class="{ active: currentType === 'BUY' }" @click="changeType('BUY')">代买</view>
            <view class="filter-item" :class="{ active: currentType === 'ERRAND' }" @click="changeType('ERRAND')">跑腿</view>
        </view>
