<template>
    <view class="publish-page">
        ...
        <view class="form-section">
            ...
            <view class="form-item contact-group">
                <text class="label required">联系方式</text>
                <text class="contact-tip">电话、微信至少填写一项</text>
                <input v-model="formData.contact_mobile" type="number" maxlength="11" placeholder="联系电话" />
                <input class="mt-input" v-model="formData.contact_wechat" placeholder="联系微信" />
            </view>
...
const submit = async () => {
    ...
    try {
        ...
        const sidRaw = currentSchool.id ?? currentSchool.school_id
        const schoolId = parseInt(String(sidRaw ?? 0), 10)
        const campusStr = String(currentSchool.campus ?? currentSchool.campus_name ?? '')
        ...
        const data = {
            ...
            school_id: Number.isFinite(schoolId) && schoolId > 0 ? schoolId : 0,
            campus: campusStr,
        }
