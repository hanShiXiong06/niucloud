<template>
    <view class="hall-page">
            ...
            <view class="filter-tabs">
                <scroll-view scroll-x class="tabs-scroll">
                    <view class="tabs-container">
                        ...
                        <view
                            class="tab-item"
                            :class="{ active: currentTaskType === 'CLASS' }"
                            @click="changeTaskType('CLASS')"
                        >代上课</view>
                        <view
                            class="tab-item"
                        ...
                        <view
                            class="tab-item"
                            :class="{ active: currentTaskType === 'PARTTIME' }"
                            @click="changeTaskType('PARTTIME')"
                        >兼职招聘</view>
                        <view
                            class="tab-item"
                            :class="{ active: currentTaskType === 'COMPANION' }"
                            @click="changeTaskType('COMPANION')"
                        >约伴组局</view>
                    </view>
                </scroll-view>
            </view>
        ...
        <!-- Order Hall List -->
        <view class="hall-content" :style="{ marginTop: (statusBarHeight + navBarHeight + 90) + 'px' }" style="position:reactive;z-index:12">
            <sd-order-item 
        ...
        <custom-tabbar v-if="config?.enable_custom_tabbar === 1" current="hall" ref="tabbarRef" />
