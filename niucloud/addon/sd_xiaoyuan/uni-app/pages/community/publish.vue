    ...
    <view class="publish-page">
        ...
        <view class="submit-bar">
            <view class="tips">
                ...
                <text v-if="config?.community_auto_approve === 1">发布即表示同意社区规范</text>
                <text v-else>发布即表示同意社区规范</text>
            </view>
...
const handleSubmit = async () => {
    ...
    try {
        ...
        if (res.code === 1) {
            const successMsg = config.value?.community_auto_approve === 1 ? '发布成功' : '发布成功，等待审核'
