...
export function setRange(data: any) {
    return request.post('sd_xiaoyuan/runner/set_range', data)
}

export function updateRunnerInfo(data: any) {
    return request.post('sd_xiaoyuan/runner/update_info', data)
}
