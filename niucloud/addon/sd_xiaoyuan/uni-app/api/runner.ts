...
export function recordRunnerSubscribe(data: { num?: number }, config: RequestExtra = {}) {
    return request.post('sd_xiaoyuan/runner/subscribe_record', data, { showSuccessMessage: false, ...config })
}
