...
// 数据概览
export function getDashboardOverview(params?: { school_id?: number }) {
    return request.get('sd_xiaoyuan/dashboard/index', { params: params || {} })
}
...
export function confirmCompleteOrder(data: any) {
    return request.post('sd_xiaoyuan/order/confirm_complete', data)
}
...
export function setRunnerCanJiedan(data: { id: number; can_jiedan: number }) {
    return request.post('sd_xiaoyuan/runner/set_can_jiedan', data, { showSuccessMessage: true })
}

export function deleteRunner(data: { id: number }) {
    return request.post('sd_xiaoyuan/runner/delete', data)
}
...
export function auditSecondhand(data: any) {
    return request.post('sd_xiaoyuan/secondhand/audit', data)
}

export function deleteSecondhand(data: any) {
    return request.post('sd_xiaoyuan/secondhand/delete', data)
}
...
export function auditLostFound(data: any) {
    return request.post('sd_xiaoyuan/lost_found/audit', data)
}

export function deleteLostFound(data: any) {
    return request.post('sd_xiaoyuan/lost_found/delete', data)
}
...
export function addPackagePrice(data: any) {
    return request.post('sd_xiaoyuan/package_price/add', data)
}

export function editPackagePrice(data: any) {
    const id = data.id
