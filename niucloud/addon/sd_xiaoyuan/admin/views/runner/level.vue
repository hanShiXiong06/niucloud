                ...
                <el-card>
                    ...
                    <div class="level-tip">
                        <el-alert type="info" :closable="false">
                            <p>佣金比例：填接单员所得%；平台抽成 = 100% - 该比例。留空则本类型用「默认佣金」列。</p>
                            <p>各列对应该类订单；跑腿为任务大厅、搜索等通用跑腿单；帮我送为帮我送专区新发的单（较早的单可能仍算在跑腿里，可把两列比例设成一样）。</p>
                        </el-alert>
                    </div>
                    <el-table :data="levelList" border>
                        ...
                        <el-table-column label="最低订单数(单)" min-width="132">
                            <template #default="{ row }">
                                <div class="min-orders-cell">
                                    <el-input-number v-model="row.min_orders" :min="0" size="small" :controls="true" class="min-orders-input" />
                                </div>
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column label="跑腿(%)" width="100">
                            <template #default="{ row }">
                                <el-input-number v-model="row.rate_errand" :min="0" :max="100" size="small" :controls="false" style="width:70px" placeholder="默认" />
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column label="代上课(%)" width="100">
                            <template #default="{ row }">
                                <el-input-number v-model="row.rate_class" :min="0" :max="100" size="small" :controls="false" style="width:70px" placeholder="默认" />
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column label="兼职招聘(%)" width="100">
                            <template #default="{ row }">
                                <el-input-number v-model="row.rate_parttime" :min="0" :max="100" size="small" :controls="false" style="width:70px" placeholder="默认" />
                            </template>
                        </el-table-column>
                        <el-table-column label="约伴组局(%)" width="100">
                            <template #default="{ row }">
                                <el-input-number v-model="row.rate_companion" :min="0" :max="100" size="small" :controls="false" style="width:70px" placeholder="默认" />
                            </template>
                        </el-table-column>
