...
namespace addon\hsx_recycle\app\adminapi\controller;

use addon\hsx_recycle\app\service\admin\DeviceQueryApiService;
use addon\hsx_recycle\app\service\admin\DeviceQueryService;
...
class DeviceQueryApiController extends BaseAdminController
{
    ...
    public function add()
    {
        ...
        $this->validate($data, 'addon\hsx_recycle\app\validate\DeviceQueryApiValidate.add');
    ...
    public function edit(int $id)
    {
        ...
        $this->validate($data, 'addon\hsx_recycle\app\validate\DeviceQueryApiValidate.edit');
