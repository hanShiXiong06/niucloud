...
namespace addon\hsx_recycle\app\adminapi\controller\address;

use addon\hsx_recycle\app\adminapi\controller\shop_address\商家地址库id;
use addon\hsx_recycle\app\service\admin\address\ShopAddressService;
 ...
 * 商家地址库控制器
 * Class ShopAddress
 * @package addon\hsx_recycle\app\adminapi\controller\shop_address
 */
class ShopAddress extends BaseAdminController
{
    ...
    public function add()
    {
        ...
        $this->validate($data, 'addon\hsx_recycle\app\validate\shop_address\ShopAddress.add');
    ...
    public function edit($id)
    {
        ...
        $this->validate($data, 'addon\hsx_recycle\app\validate\shop_address\ShopAddress.edit');
