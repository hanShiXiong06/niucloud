...
namespace addon\hsx_recycle\app\adminapi\controller\price_image;

use addon\hsx_recycle\app\service\admin\price_image\PriceImageService;
use addon\hsx_recycle\app\service\admin\recycle_excel\RecycleExcelService;
 ...
 * @package addon\hsx_recycle\app\adminapi\controller\price_image
 */
class PriceImageController extends BaseAdminController
{
    ...
    public function debugData()
    {
        try {
            ...
            $service = new PriceImageService();
            $excelService = new \addon\hsx_recycle\app\service\admin\recycle_excel\RecycleExcelService();
