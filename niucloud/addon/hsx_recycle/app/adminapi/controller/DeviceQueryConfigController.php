...
use addon\hsx_recycle\app\service\admin\DeviceQueryConfigService;
...
class DeviceQueryConfigController extends BaseAdminController
{
    ...
    public function add()
    {
        ...
        // $this->validate($data, 'addon\hsx_recycle\app\validate\DeviceQueryConfigValidate.add');
    ...
    public function edit(int $id)
    {
        ...
        // $this->validate($data, 'addon\hsx_recycle\app\validate\DeviceQueryConfigValidate.edit');
