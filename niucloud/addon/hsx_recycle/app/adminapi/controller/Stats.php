<?php
// addon/hsx_recycle/app/adminapi/controller/Stats.php
declare(strict_types=1);

namespace addon\hsx_recycle\app\adminapi\controller;

use core\base\BaseAdminController;
use addon\hsx_recycle\app\service\admin\stats\StatsService;
use addon\hsx_recycle\app\service\admin\stats\RecycleStatsService;
use addon\hsx_recycle\app\service\admin\dashboard\RecycleDashboardWidgetService;
use think\Response;
use think\App;
