...
Route::group('recycle', function () {
   ...
   Route::get('recycle_order/staff_count', 'addon\hsx_recycle\app\adminapi\controller\Stats@inspectorPerformance');
    ...
    // 设备管理
    Route::get('recycle_device/:id/detail_view', 'addon\hsx_recycle\app\adminapi\controller\order\RecycleDevice@detailView');
...
Route::group('recycle', function () {
    ...
    Route::post('device_export/export', 'addon\hsx_recycle\app\adminapi\controller\device\export\DeviceExportController@export');
