...
namespace addon\hsx_recycle\app\service\admin\sys;
 ...
 * @package addon\hsx_recycle\app\service\admin\sys
 */
class ShortLinkService extends BaseAdminService
{
    ...
    public function generateOrderShortLink(array $data): array
    {
        ...
        $page_url = "addon/hsx_recycle/pages/order/detail?id={$order_id}";
