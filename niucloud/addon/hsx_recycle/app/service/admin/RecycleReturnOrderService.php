...
use addon\hsx_recycle\app\service\core\RecycleReturnOrderService as CoreRecycleReturnOrderService;
...
class RecycleReturnOrderService extends BaseAdminService
{
    ...
    public function getPage(array $where): array
    {
        ...
        // 构建查询模型
        $search_model = new \addon\hsx_recycle\app\model\RecycleReturnOrder();
