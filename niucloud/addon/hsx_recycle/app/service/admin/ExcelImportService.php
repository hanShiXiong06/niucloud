...
use addon\hsx_recycle\app\model\RecycleDeviceBrand;
use addon\hsx_recycle\app\model\RecycleDeviceModel;
use addon\hsx_recycle\app\model\RecycleDevicePrice;
use addon\hsx_recycle\app\model\RecyclePriceImportRecord;
...
class ExcelImportService extends BaseAdminService
{
    ...
    protected function processDeviceAndPrice(
        ...
        if ($existingModel) {
            ...
            try {
                // 创建新的模型实例以避免ID被复用
                $newModel = new \addon\hsx_recycle\app\model\RecycleDeviceModel();
        ...
        if (!$modelId) {
            ...
            if ($existingPrice) {
                ...
                // 插入新价格
                $newPriceModel = new \addon\hsx_recycle\app\model\RecycleDevicePrice();
