...
class RecycleDashboardWidgetService extends BaseAdminService
{
    ...
    public static function builtinWidgets(): array
    {
        return [
            ...
            'site_today_consignment_count' => [
                'widget_key' => 'site_today_consignment_count',
                'widget_name' => '今日代卖数',
                'widget_type' => 'stat',
                'data_key' => 'today_consignment_count',
                'data_scope' => 'site',
                'sort' => 150,
                'config' => ['unit' => '单', 'color' => 'purple'],
            ],
            'site_consignment_listing_count' => [
                'widget_key' => 'site_consignment_listing_count',
                'widget_name' => '挂牌中',
                'widget_type' => 'stat',
                'data_key' => 'consignment_listing_count',
                'data_scope' => 'site',
                'sort' => 155,
                'config' => ['unit' => '台', 'color' => 'orange'],
            ],
            'site_consignment_sold_amount' => [
                'widget_key' => 'site_consignment_sold_amount',
                'widget_name' => '代卖成交额',
                'widget_type' => 'stat',
                'data_key' => 'consignment_sold_amount',
                'data_scope' => 'site',
                'sort' => 160,
                'config' => ['unit' => '元', 'color' => 'green', 'precision' => 2],
            ],
            'site_consignment_service_fee' => [
                'widget_key' => 'site_consignment_service_fee',
                'widget_name' => '代卖服务收益',
                'widget_type' => 'stat',
                'data_key' => 'consignment_service_fee',
                'data_scope' => 'site',
                'sort' => 165,
                'config' => ['unit' => '元', 'color' => 'teal', 'precision' => 2],
            ],
            'site_pending_return' => [
                'widget_key' => 'site_pending_return',
                'widget_name' => '待退回',
                'widget_type' => 'stat',
                'data_key' => 'pending_return',
                'data_scope' => 'site',
                'sort' => 170,
                'config' => ['unit' => '台', 'color' => 'red'],
            ],
            'site_pending_confirm' => [
                'widget_key' => 'site_pending_confirm',
                'widget_name' => '待确认',
                'widget_type' => 'stat',
                'data_key' => 'pending_confirm_count',
                'data_scope' => 'site',
                'sort' => 175,
                'config' => ['unit' => '台', 'color' => 'amber'],
            ],
    ...
    protected function buildMetricMap(array $widgets, array $params): array
    {
        ...
        $needOverview = (bool)array_intersect($dataKeys, [
            ...
            'today_return_count',
            'today_check_breakdown',
            'today_consignment_count',
            'consignment_listing_count',
            'consignment_sold_amount',
            'consignment_service_fee',
            'today_return_device_count',
            'pending_return',
