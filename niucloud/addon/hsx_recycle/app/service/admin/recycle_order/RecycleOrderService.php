...
namespace addon\hsx_recycle\app\service\admin\recycle_order;

use addon\hsx_recycle\app\dict\order\RecycleOrderDict;
use addon\hsx_recycle\app\model\RecycleOrder;
use addon\hsx_recycle\app\model\RecycleDevice;
use addon\hsx_recycle\app\model\RecycleOrderLog;
use core\base\BaseAdminService;
use app\service\core\notice\NoticeService;
use core\exception\CommonException;
use addon\hsx_recycle\app\service\admin\order\RecycleOrderSignService;
 ...
 * @package addon\hsx_recycle\app\service\admin\recycle_order
 */
class RecycleOrderService extends BaseAdminService
{
    ...
    public function add(array $data): int
    {
        ...
        try {
            ...
            // 触发订单下单通知
            (new \addon\hsx_recycle\app\service\core\recycle_order\CoreRecycleOrderNotifyService())->orderAddNotify(['order_id' => $order->id , 'site_id'=>$this->site_id]);
            
            // 触发订单下单后事件
            \addon\hsx_recycle\app\service\core\order\CoreRecycleOrderEventService::orderAddAfter(['order_id' => $order->id, 'site_id' => $this->site_id, 'member_id' => $data['member_id'] ?? 0]);
   ...
   /**
    ...
    public function cancel(int $id, array $data): bool
    {
        ...
        try {
            // 更新订单状态
            $updateData = [
                'cancel_reason' => $data['cancel_reason'] ?? '管理员操作'
            ];
    ...
    */
    ...
    {
       // 通过$id 查询商户的收款信息
       $payment_service = new \addon\hsx_recycle\app\service\admin\payment\PaymentService();
