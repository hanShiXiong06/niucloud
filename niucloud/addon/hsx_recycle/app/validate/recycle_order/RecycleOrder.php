...
namespace addon\hsx_recycle\app\validate\recycle_order;
 ...
 * 回收订单验证器
 * Class RecycleOrder
 * @package addon\hsx_recycle\app\validate\recycle_order
 */
class RecycleOrder extends Validate
{
    ...
    protected $rule = [
        ...
        'devices' => 'array',
        'devices.*.imei' => 'requireWithout:devices.*.model|max:15',
