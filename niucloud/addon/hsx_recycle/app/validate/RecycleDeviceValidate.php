 ...
 * @package addon\hsx_recycle\app\validate
 */
class RecycleDeviceValidate extends BaseValidate
{
    protected $rule = [
        ...
        'remark' => 'max:500',
        // 这些列在库里是 text(最长 65535),验证上限对齐列宽,避免开 failException 后长质检结果被误拦
        'check_result' => 'max:65535',
        'check_result_seller' => 'max:65535',
        'check_result_buyer' => 'max:65535',
        'check_images' => 'max:65535',
        'check_images_seller' => 'max:65535',
        'check_images_buyer' => 'max:65535',
    ...
    protected $message = [
        ...
        'sell_price.float' => '卖货价格必须为数字',
        'sell_price.egt' => '卖货价格必须大于等于0',
        'status.integer' => '状态必须为整数',
        'status.in' => '状态值不正确',
        'remark.max' => '备注不能超过500个字符',
        'check_result.max' => '质检结果不能超过1000个字符',
        'check_result_seller.max' => '卖家质检结果不能超过1000个字符',
        'check_result_buyer.max' => '买家质检结果不能超过1000个字符',
        'check_images.max' => '质检图片不能超过1000个字符',
        'check_images_seller.max' => '卖家质检图片不能超过1000个字符',
        'check_images_buyer.max' => '买家质检图片不能超过1000个字符',
    ...
    protected $scene = [
        ...
        'update' => ['id', 'imei', 'model', 'initial_price', 'final_price', 'sell_price', 'status', 'remark', 'check_result', 'check_result_seller', 'check_result_buyer', 'check_images', 'check_images_seller', 'check_images_buyer', 'check_status', 'price_remark'],
        'delete' => ['id'],
        'check' => ['id', 'remark', 'check_result', 'check_result_seller', 'check_result_buyer', 'check_images', 'check_images_seller', 'check_images_buyer', 'check_status', 'final_price', 'sell_price'],
        'price' => ['id', 'final_price', 'sell_price', 'price_remark', 'remark'],
        'recycle' => ['id', 'remark'],
        'return' => ['id', 'remark'],
