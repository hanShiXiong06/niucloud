...
class RecycleOrderValidate extends BaseValidate
{
    protected $rule = [
        ...
        'delivery_type' => 'integer|in:1,2,3',
        'logistics_name' => 'max:100',
        'logistics_vehicle_no' => 'max:50',
        'logistics_contact_name' => 'max:50',
        'logistics_contact_mobile' => 'max:30',
        'logistics_pickup_address' => 'max:255',
        'remark' => 'max:500',
        'devices' => 'array',
        'pay_account' => 'max:100',
        'pay_type' => 'max:50',
    ...
    protected $scene = [
        'list' => ['page', 'limit'],
        'detail' => ['id'],
        'create' => ['member_id', 'customer_name', 'customer_phone', 'express_no', 'express_company', 'delivery_type', 'logistics_name', 'logistics_vehicle_no', 'logistics_contact_name', 'logistics_contact_mobile', 'logistics_pickup_address', 'remark', 'count', 'devices'],
