...
namespace addon\hsx_recycle\app\model;

use core\base\BaseModel;
use addon\hsx_recycle\app\dict\order\RecycleOrderDict;
use addon\hsx_recycle\app\model\recycle_user_address\RecycleUserAddress;
...
class RecycleOrder extends BaseModel
{
    ...
    {
        $type = (string)($data['delivery_type'] ?? RecycleOrderDict::DELIVERY_TYPE_EXPRESS);
        return match ($type) {
