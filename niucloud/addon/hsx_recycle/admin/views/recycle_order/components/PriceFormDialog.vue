...
.pfd-metric {
  ...
  strong { font-size: 13px; color: #111827; }

  &__primary { color: #dc2626 !important; }
}
...
.pfd-process-note {
  ...
  span { font-size: 12px; line-height: 1.6; color: #78350f; }
}
...
.pfd-print-tip {
  ...
  strong { font-size: 12px; color: #3730a3; }
  span { font-size: 12px; line-height: 1.6; color: #4338ca; }
}
