...
```bash
cd /Users/a123/Documents/1-work/niucloud/niucloud/admin/src/addon/hsx_recycle/views/stats
...
<!-- 在任何页面导入并使用 -->
<script setup>
import StatCard from '@/addon/hsx_recycle/views/stats/components/StatCard.vue'
</script>
