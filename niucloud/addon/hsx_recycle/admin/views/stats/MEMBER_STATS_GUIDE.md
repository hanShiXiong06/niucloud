...
- `GET /hsx_recycle/stats/getMemberStatsOverview`
- `GET /hsx_recycle/stats/getMemberRegisterTrend`
- `GET /hsx_recycle/stats/getMemberChannelStats`
- `GET /hsx_recycle/stats/getMemberInviteRank`
- `GET /hsx_recycle/stats/getMemberActivityStats`
...
### 后端
- `niucloud/addon/hsx_recycle/app/service/admin/stats/RecycleStatsService.php`
- `niucloud/addon/hsx_recycle/app/adminapi/controller/Stats.php`

### 前端
- `admin/src/addon/hsx_recycle/api/stats.ts`
- `admin/src/addon/hsx_recycle/views/stats/hooks/useStatsData.ts`
- `admin/src/addon/hsx_recycle/views/stats/hooks/useCharts.ts`
- `admin/src/addon/hsx_recycle/views/stats/dashboard.vue`
