...
export function getReturnOrderList(params = {}) {
  return request({
    url: "/api/hsx_recycle/recycle_return_order/lists",
    method: "get",
    data: params,
  });
}
...
export function getReturnOrderDetail(id) {
  return request({
    url: "/api/hsx_recycle/recycle_return_order/detail",
    method: "get",
    data: { id },
  });
}
...
export function confirmReceiveReturnOrder(id, data = {}) {
  return request({
    url: "/api/hsx_recycle/recycle_return_order/confirm",
    method: "post",
    data: {
      id,
      ...data,
...
export function getReturnOrderStatusCount() {
  return request({
    url: "/api/hsx_recycle/recycle_return_order/status_count",
    method: "get",
  });
}
