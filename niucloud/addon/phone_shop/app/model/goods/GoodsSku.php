 ...
 * 商品规格模型
 * Class GoodsSku
 * @package addon\phone_shop\app\model\goods_sku
 */
class GoodsSku extends BaseModel
{
     ...
     * @var string
     */
    protected $name = 'phone_shop_goods_sku';
