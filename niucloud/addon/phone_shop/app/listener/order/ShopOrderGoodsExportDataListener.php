    ...
    public function handle($param)
    {
        ...
        if ($param['type'] == 'shop_order_goods') {
            ...
            foreach ($data as $key => $val){
                ...
                $data[$key]['pay_time'] = !empty($val['orderMain']['pay_time']) ? $val['orderMain']['pay_time'] : '0000-00-00 00:00:00';
                $data[$key]['delivery_time'] = !empty($val['orderMain']['delivery_time']) ? $val['orderMain']['delivery_time'] : '0000-00-00 00:00:00';
                $data[$key]['finish_time'] = !empty($val['orderMain']['finish_time']) ? $val['orderMain']['finish_time'] : '0000-00-00 00:00:00';
