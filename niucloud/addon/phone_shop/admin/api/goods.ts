...
export function addLabelGroup(params: Record<string, any>) {
  return request.post("phone_shop/goods/label/group", params, {
    showErrorMessage: true,
    showSuccessMessage: true,
  });
}
...
export function editLabelGroup(params: Record<string, any>) {
  return request.put(
    `phone_shop/goods/label/group/${params.group_id}`,
    params,
    {
      showErrorMessage: true,
      showSuccessMessage: true,
...
export function modifyLabelStatus(params: Record<string, any>) {
  return request.put(`phone_shop/goods/label/status`, params, {
    showSuccessMessage: true,
  });
}
...
export function deleteLabelGroup(group_id: number) {
  return request.delete(`phone_shop/goods/label/group/${group_id}`, {
    showErrorMessage: true,
    showSuccessMessage: true,
  });
}
...
export function modifyLabelGroupSort(params: Record<string, any>) {
  return request.put(`phone_shop/goods/label/group/sort`, params, {
    showSuccessMessage: true,
  });
}
