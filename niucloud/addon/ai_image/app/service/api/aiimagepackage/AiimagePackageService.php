...
namespace addon\ai_image\app\service\api\aiimagepackage;
 ...
 */
class AiimagePackageService extends BaseApiService
{
    ...
    public function getPage(array $where = [])
    {
        ...
        $search_model = $this->model->where([ [ 'site_id' ,"=", $this->site_id ] ])
            ->where(['status' => 1])
            ->withSearch(["name","type","status"], $where)->field($field)->order($order);
