...
namespace addon\ai_image\app\api\controller\aiimagepackage;

use core\base\BaseApiController;
use addon\ai_image\app\service\api\aiimagepackage\AiimagePackageService;
 ...
 */
class AiimagePackage extends BaseApiController
{
   /**
    * 获取套餐列列表
