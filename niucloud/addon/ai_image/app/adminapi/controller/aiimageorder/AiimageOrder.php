...
namespace addon\ai_image\app\adminapi\controller\aiimageorder;

use core\base\BaseAdminController;
use addon\ai_image\app\service\admin\aiimageorder\AiimageOrderService;
 ...
 */
class AiimageOrder extends BaseAdminController
{
   /**
    * 获取订单列列表
    ...
    */
    ...
    public function add(){
        ...
        $id = (new AiimageOrderService())->add($data);
