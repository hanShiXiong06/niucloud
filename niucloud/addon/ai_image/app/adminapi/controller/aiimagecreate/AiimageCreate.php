...
namespace addon\ai_image\app\adminapi\controller\aiimagecreate;

use core\base\BaseAdminController;
use addon\ai_image\app\service\admin\aiimagecreate\AiimageCreateService;
 ...
 */
class AiimageCreate extends BaseAdminController
{
   /**
    * 获取作品列列表
