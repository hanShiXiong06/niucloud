...
import { getConsignmentOrderList, getConsignmentStatusOptions } from '@/addon/recycle/api/consignment'
import { formatMoney, formatTime, makePhoneCall } from '@/addon/recycle/utils/helper'
...
const toDetail = (id: number | string) => {
    redirect({ url: '/addon/recycle/pages/consignment/detail', param: { id } })
}
