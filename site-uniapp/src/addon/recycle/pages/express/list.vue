            ...
            <scroll-view scroll-x class="border-b border-[#f0f0f0]">
                <view class="flex whitespace-nowrap px-[20rpx] py-[16rpx]">
                    <view
                        ...
                        :class="currentStatus === item.value ? 'text-[#2979ff] font-bold' : 'text-[#666]'"
...
import { getExpressOrderRecordList, getExpressOrderStatistics } from '@/addon/recycle/api/express'
...
const toDetail = (id: number | string) => {
    redirect({ url: '/addon/recycle/pages/express/detail', param: { id } })
}
