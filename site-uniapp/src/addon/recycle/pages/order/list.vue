...
import { getOrderList, pushOrderNotify, updateOrder } from '@/addon/recycle/api/order'
...
import { getDevicePriceLabel, isConsignedDevice, shouldShowConfirmStatus } from '@/addon/recycle/utils/device'
import { makePhoneCall } from '@/addon/recycle/utils/helper'
...
const toDetail = (item: any, filter = '') => {
    ...
    redirect({ url: '/addon/recycle/pages/order/detail', param: { id: item.id, filter } })
}
