    ...
    <u-popup :show="show" mode="bottom" round="20" :safeAreaInsetBottom="true" @close="handleClose">
        <view class="popup-container">
            <view class="popup-header">
                <view class="popup-title">结算客户</view>
                <text class="nc-iconfont nc-icon-guanbiV6xx1" @click="handleClose"></text>
            </view>

            <view class="popup-body">
                <view class="form-item">
                    <view class="form-label">结算金额 <text class="required">*</text></view>
...
watch(() => props.visible, (value) => {
    ...
    if (value) {
        formData.value = {
            settlement_amount: props.defaultAmount ? String(props.defaultAmount) : '',
            remark: ''
        }
