...
export function usernameLogin(data: AnyObject) {
    return request.get('login/site', data, { showErrorMessage: true })
}
...
export function mobileLogin(data: AnyObject) {
    return request.post('login/mobile/site', data, { showErrorMessage: true })
}
 ...
 * 用户名注册
 */
export function siteRegister(data: AnyObject) {
    return request.post('wuxinggou/site/auth/register', data, { showErrorMessage: true })
}
