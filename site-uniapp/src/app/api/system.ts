...
export function sendSms(data: AnyObject) {
    return request.post(`send/mobile/${ data.type }/site`, data, { showErrorMessage: true })
}
...
export function uploadImage(data: AnyObject) {
    return request.upload('sys/image', data, { showErrorMessage: true })
}

/**
 * 上传图片
 */
export function uploadSiteImage(data: AnyObject) {
    return request.upload('wuxinggou/shop_setup/image', data, { showErrorMessage: true })
}
...
export function uploadVideo(data: AnyObject) {
    return request.upload('sys/video', data, { showErrorMessage: true })
}
 ...
 * 获取底部导航
 */
export function getSiteNavs() {
    return request.get('adminapp/site/navs', )
}

// getAttachmentConfig 
export function getAttachmentConfig () {
    return request.get('adminapp/site/attachment_config' )
}

// getAttachmentCategoryList
export function getAttachmentCategoryList() {
    return request.get('adminapp/site/attachment_category_list', )
}
// getAttachmentList 
export function getAttachmentList() {
    return request.get('adminapp/site/attachment_list', )
}
// uploadImageBase64
export function uploadImageBase64() {
    return request.get('adminapp/site/upload_image_base64', )
}
