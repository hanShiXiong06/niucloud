<template>
    <div class="main-container">
        ...
        <order-notes ref="orderNotesDialog" @complete="loadOrderList(getTablePageStorage(orderTable.searchParam).page)"></order-notes>
        <export-sure ref="exportSureDialog" :show="flag" type="phone_shop_order_refund" :searchParam="orderTable.searchParam" @close="handleClose" />
        <refund-detail ref="refundDetailDialog" @load="loadOrderList(getTablePageStorage(orderTable.searchParam).page)"></refund-detail>
    </div>
</template>
...
import { t } from '@/lang'
import { orderRefund } from '@/addon/phone_shop/api/order'
import { img, filterNumber, setTablePageStorage, getTablePageStorage } from '@/utils/common'
import type { FormInstance } from 'element-plus'
import { useRouter, useRoute } from 'vue-router'
import refundDetail from '@/addon/phone_shop/views/order/components/refund-detail.vue'
