...
import { getCouponInfo, sendCoupon, initCoupon } from '@/addon/phone_shop/api/marketing'
import { getMemberLabelAll, getMemberLevelAll } from '@/app/api/member'
import selectMember from '@/addon/phone_shop/views/marketing/coupon/components/select-member.vue'
