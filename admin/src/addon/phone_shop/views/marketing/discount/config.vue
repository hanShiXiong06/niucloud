        ...
        <el-card class="box-card !border-none" shadow="never">
            ...
            <div class="flex mt-[20px]">
                <div class="relative overflow-hidden w-[340px] h-[680px] z-0 bg-[#f5f5f5]">
                    <img class="absolute top-0 left-0 z-10 pointer-events-none" src="@/addon/phone_shop/assets/discount_config.png"/>
                    <div class="absolute top-0 left-0 w-[340px]">
                        <img class="w-full h-[256px]" v-if="isShow" src="@/addon/phone_shop/assets/discount_banner.png">
...
import {getActiveDiscountConfig,editActiveDiscountConfig} from "@/addon/phone_shop/api/marketing";
