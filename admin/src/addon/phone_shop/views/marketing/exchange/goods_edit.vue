                                ...
                                <el-image v-if="formData.goods_info.goods_cover" class="w-[78px] h-[78px]" :src="img(formData.goods_info.goods_cover)" fit="contain">
                                    <template #error>
                                        <div class="image-slot">
                                            <img class="w-[78px] h-[78px]" src="@/addon/phone_shop/assets/goods_default.png" />
                                        </div>
                                    </template>
                                </el-image>
                                <img v-else class="w-[78px] h-[78px]" src="@/addon/phone_shop/assets/goods_default.png" fit="contain" />
                            </div>
...
import { getActiveExchangeInfo, editActiveExchange } from '@/addon/phone_shop/api/marketing'
