                    ...
                    <template #default="{ row }">
                        <div class="flex cursor-pointer" v-for="item in row.order_goods">
                            <div class="flex items-center min-w-[50px] mr-[10px]">
                                ...
                                <img class="w-[50px] h-[50px]" v-else src="@/addon/phone_shop/assets/goods_default.png" alt="">
                            </div>
...
import { t } from '@/lang'
import { getOrderList, getOrderStatus, getOrderPayType, getOrderFrom } from '@/addon/phone_shop/api/order'
