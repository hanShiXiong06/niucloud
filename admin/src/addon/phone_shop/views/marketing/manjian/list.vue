...
import { closeManjian, deleteManjian, getManjianList, getManjianStatusList, batchCloseMajian, batchDeleteManjian } from '@/addon/phone_shop/api/marketing'
import { FormInstance, ElMessageBox, ElMessage } from 'element-plus'
import manjianDetail from '@/addon/phone_shop/views/marketing/manjian/detail.vue'
