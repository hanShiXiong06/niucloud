...
import {optionData,getRankInfo,addGoodRank,editGoodRank,} from "@/addon/phone_shop/api/marketing";
import goodsSelectPopup from "@/addon/phone_shop/views/goods/components/goods-select-popup.vue";
import {getBrandList,getLabelList,getCategoryTree} from "@/addon/phone_shop/api/goods";
