...
import couponSelectPopup from '@/addon/phone_shop/views/goods/components/coupon-select-popup.vue'
...
const couponStyleList = reactive([
    {
        url: 'addon/phone_shop/diy/goods_coupon/style-1.png',
        title: '风格1',
        value: 'style-1'
    },
    {
        url: 'addon/phone_shop/diy/goods_coupon/style-2.png',
        title: '风格2',
        value: 'style-2'
    },
    {
        url: 'addon/phone_shop/diy/goods_coupon/style-3.png',
        title: '风格3',
        value: 'style-3'
    },
    {
        url: 'addon/phone_shop/diy/goods_coupon/style-4.png',
        title: '风格4',
        value: 'style-4'
    }
])
