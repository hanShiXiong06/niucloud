<template>
            ...
            <el-form label-width="80px" class="px-[10px]">
                <el-form-item :label="t('selectStyle')" class="flex">
                    <span class="text-primary flex-1 cursor-pointer"
                          @click="showTitleStyle">{{ diyStore.editComponent.style.title }}</span>
            ...
            <el-dialog v-model="showTitleDialog" :title="t('selectStyle')" width="460px">
                <div class="flex flex-wrap">
                    <template v-for="(item,index) in styleList" :key="index">
                        <div :class="{ 'border-primary': selectStyle.value == item.value }"
    ...
    <div class="style-wrap" v-show="diyStore.editTab == 'style'">
        ...
        <div class="edit-attr-item-wrap"
             v-if="diyStore.editComponent && diyStore.editComponent.style && diyStore.editComponent.style.value == 'style-3'">
...
import newcomerGoodsSelectPopup from '@/addon/phone_shop/views/goods/components/newcomer-goods-select-popup.vue'
...
const styleList = reactive([
    {
        url: 'addon/phone_shop/diy/newcomer/style_01.png',
        title: '风格1',
        value: 'style-1'
    }, {
        url: 'addon/phone_shop/diy/newcomer/style_02.png',
        title: '风格2',
        value: 'style-2'
    }, {
        url: 'addon/phone_shop/diy/newcomer/style_03.png',
        title: '风格3',
        value: 'style-3'
    }, {
        url: 'addon/phone_shop/diy/newcomer/style_04.png',
        title: '风格4',
        value: 'style-4'
    }
])
...
const initStyle = (style: any) => {
    if (style == 'style-1') {
        diyStore.editComponent.textImg = "addon/phone_shop/diy/newcomer/style_title_01.png";
        ...
        diyStore.editComponent.textImg = "addon/phone_shop/diy/newcomer/style_title_02.png";
        ...
        diyStore.editComponent.textImg = "addon/phone_shop/diy/newcomer/style_title_03.png";
