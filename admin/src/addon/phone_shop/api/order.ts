...
export function orderDelete(params: Record<string, any>) {
    return request.post(`phone_shop/order/delete`,params, { showSuccessMessage: true })
}
...
export function shopActiveRefund(params: Record<string, any>) {
    return request.post(`phone_shop/order/refund/active`, params, { showSuccessMessage: true })
}
...
export function createInvoice(params: Record<string, any>) {
    return request.post(`phone_shop/invoice/add`, params, { showSuccessMessage: true })
}
...
export function auditInvoice(params: Record<string, any>) {
    return request.post(`phone_shop/invoice/audit`, params, { showSuccessMessage: true })
}
...
export function closeRefund(order_refund_no: number) {
    return request.put(`phone_shop/order/refund/close/${order_refund_no}`)
}
...
export function getSelectOrderGoodsWeight(params: Record<string, any>) {
    return request.get(`phone_shop/order/select/weight`, {params})
}
...
export function getDeliveryFee(params: Record<string, any>) {
    return request.get(`phone_shop/order/delivery/fee`, {params})
}