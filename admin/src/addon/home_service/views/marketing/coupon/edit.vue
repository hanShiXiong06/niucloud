                        ...
                        <el-table-column prop="goods_id" :label="t('goodsSelectPopupGoodsInfo')" min-width="300">
                            <template #default="{ row }">
                                ...
                                <div class="min-w-[60px] h-[60px] flex items-center justify-center">
                                    ...
                                    <img v-else class="w-[70px] h-[60px]" src="@/addon/home_service/assets/goods_default.png" fit="contain" />
                                </div>
                                <div class="ml-2">
...
import { getGoodsCategoryList, editCoupon, getCouponInfo } from '@/addon/home_service/api/marketing'
...
const initialFormData = {
    ...
    min_condition_money: '', // 服务最低多少金额可用优惠券
    length: 30, // 有效期时长(天)
    goods_ids: [], // 关联服务id
    goods_category_ids: [], // 关联服务分类id
    receive_type_time: 2,
...
const formRules = computed(() => {
    return {
        ...
        goods_ids: [
            { required: true, message: t('请选择服务'), trigger: 'blur' }
        ],
        goods_category_ids: [
            { required: true, message: t('请选择服务分类'), trigger: 'blur' }
        ],
        min_condition_money: [
...
const back = () => {
    router.push('/home_service/marketing/coupon/list')
}
</script>
