                ...
                <div class="banner-item" v-for="(item, idx) in diyStore.editComponent.list" :key="idx">
                    <el-form label-width="80px" class="px-[10px]">
                        ...
                        <el-form-item label="图标">
                            <el-input v-model="item.icon" placeholder="图标名称" size="small" />
                        </el-form-item>
                        <el-form-item label="背景色">
                            <el-input v-model="item.bgColor" placeholder="渐变色或纯色" size="small" />
                        </el-form-item>
                        <el-form-item label="链接">
                            <el-input v-model="item.url" placeholder="跳转链接" size="small" />
                        </el-form-item>
