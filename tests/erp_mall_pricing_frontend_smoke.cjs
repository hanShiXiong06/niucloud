...
const files = ["niucloud/addon/phone_shop/admin/views/goods/price_rules.vue","niucloud/addon/phone_shop/admin/views/goods/components/TierPriceInput.vue","niucloud/addon/phone_shop/admin/views/goods/real_edit.vue","niucloud/addon/phone_shop/admin/views/goods/components/goods-price-edit-popup.vue","niucloud/addon/phone_shop/admin/views/goods/components/goods-member-price-popup.vue","niucloud/addon/phone_shop/admin/views/intake/list.vue","niucloud/addon/hsx_erp/admin/components/ErpListingWorkspaceForm.vue","niucloud/addon/hsx_erp/admin/views/erp/stock/list.vue","site-uniapp/src/addon/hsx_erp/pages/stock/detail.vue","site-uniapp/src/addon/hsx_erp/components/ErpListingWorkspaceForm.vue","site-uniapp/src/addon/phone_shop/pages/goods/add.vue"];
files.push('niucloud/addon/phone_shop/admin/views/goods/components/goods-transfer-dialog.vue')
...
const mirrors = [["phone_shop","api/tier_pricing.ts"],["phone_shop","views/goods/price_rules.vue"],["phone_shop","views/goods/components/TierPriceInput.vue"],["phone_shop","views/goods/real_edit.vue"],["phone_shop","views/goods/public/js/useGoodsEdit.ts"],["phone_shop","views/goods/components/goods-price-edit-popup.vue"],["phone_shop","views/goods/components/goods-member-price-popup.vue"],["phone_shop","views/intake/list.vue"],["hsx_erp","components/ErpListingWorkspaceForm.vue"],["hsx_erp","hooks/useSalesPricing.ts"],["hsx_erp","views/erp/stock/list.vue"]]
mirrors.push(['phone_shop','views/goods/components/goods-transfer-dialog.vue'])
