...
import { getRecycleUserAddressInfo, addRecycleUserAddress, editRecycleUserAddress } from '@/addon/hsx_recycle/api/return_order';
				...
				try {
					uni.navigateBack({
						...
						fail: (err: any) => {
							...
							uni.switchTab({ url: '/addon/hsx_recycle/pages/order/index' }); // 兜底跳转
						}
					});
				} catch (navError) {
