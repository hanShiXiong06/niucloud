...
import { getHot, getCategoryTree } from '@/addon/hsx_recycle/api/recycle'; // 添加树形分类API
...
const handleApiItemClick = (item: RecycleCategoryFromApi) => {
    ...
    if (item.images && item.images.length > 0) {
        ...
        // router.push({ path: '/addon/hsx_recycle/pages/category/detail', query: { category_id: item.category_id } });
    }
};
