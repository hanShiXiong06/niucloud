<template>
	...
	<view class="base-nav-wrap">
		...
		paddingBottom:navPaddingBottom + 'px'
			...
			<!-- #ifdef H5 -->
			<view class="text-[#fff] text-center font-bold">订单中心</view>
			<!-- 导航栏内容区：居中标题 -->
			<!-- <view class=" flex justify-between bg-[#111] w-[100%] h-[100%]">
				...
				<view class="" >
					<view class="p-[15rpx] box-border bg-[#2A2A2A] rounded-[50%] relative">
						<text
							class="absolute text-[#fff] bg-[#FF0000] rounded-[50%] text-[20rpx] p-[2rpx] w-[30rpx] h-[30rpx] flex items-center justify-center right-[-10rpx] top-[-10rpx]">5</text>
			...
			<view class=" flex justify-between bg-[#111] w-[100%] h-[100%]">
				...
				<view class="" :style="{marginRight:navRight + 15 + 'px'}" >
		...
		<u-picker :show="statusShow" :defaultIndex="[statusIndex]" :columns="columns" keyName="name" :closeOnClickOverlay="true" @close="closeStatus" @confirm="confirmStatus"></u-picker>
