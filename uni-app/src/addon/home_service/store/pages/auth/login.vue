<template>
    <view class="w-screen h-screen flex flex-col  "
        :style="'background:url(' + img('addon/home_service/store/auth/store_auth_background.png') + ');background-size: 100% 100%;'"
        v-if="type">
        ...
        <view class="mx-[60rpx]">
                    ...
                    <view class="h-[88rpx] flex w-full items-center px-[30rpx]  box-border bg-[rgb(255,255,255,0)]"
                        ...
                        <u-form-item label="" prop="username" :border-bottom="false">
                            <u-input v-model="formData.username" border="none" maxlength="40"
                                ...
                                <template #suffix>
                                    <!-- #ifndef APP-PLUS -->
                                    <view @click="clearUsername" v-if="formData.username">
                                        <u-icon name="close-circle-fill" color="#b9b9b9" size="20"></u-icon>
                                    </view>
                                    <!-- #endif -->
                                </template>
                            </u-input>
                        ...
                        <u-form-item label="" prop="mobile_code" :border-bottom="false">
                            <u-input v-model="formData.mobile_code" type="number" maxlength="4" border="none"
                                ...
                                <template #suffix>
                                    ...
                                    <sms-code v-else :mobile="formData.mobile" type="login"
            ...
            <!-- <view class="h-[34rpx] text-right text-[24rpx] text-[var(--store-bg-one)] leading-[34rpx] mt-[20rpx] " @click="toResetpwd">{{ type == 'username' ? t('resetpwd') : '' }}</view> -->
            <view class="mt-[106rpx]">
                <view v-if="configStore.login.agreement_show"
                    class="flex items-center mt-[20rpx] py-[14rpx]  mb-[20rpx]" @click.stop="agreeChange">
                    <u-checkbox-group @change="agreeChange">
                        <u-checkbox activeColor="var(--store-bg-one)" :checked="isAgree" shape="circle"
                            size="24rpx" />
                    </u-checkbox-group>
                    <view
        ...
        <uni-popup ref="popupRef" type="dialog">
            <view
                ...
                <view>
                    <view
                        class="w-[100%] flex justify-center bg-[var(--store-bg-one)] h-[70rpx] leading-[70rpx] text-[#fff] text-[26rpx] border-[0] font-500 rounded-[50rpx]"
