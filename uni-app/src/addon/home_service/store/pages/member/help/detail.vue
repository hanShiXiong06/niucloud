    ...
    <view class="content p-3">
      <view class="bg-white rounded-lg shadow-sm p-4">
        ...
        <view class="rich-content">
          <!-- 修改tag-style为正确的格式 -->
          <u-parse :content="helpDetail.content || ''" :tag-style="{p: 'margin: 0 0 16px 0', img: 'max-width: 100%'}"></u-parse>
        </view>
...
import { getHelpDetail } from '@/addon/home_service/store/api/member'
