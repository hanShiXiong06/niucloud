            ...
            <view class="flex border-b border-[#f0f0f0] overflow-x-auto whitespace-nowrap">
              ...
              >
                ...
                <view 
                  ...
                  class="absolute bottom-0 left-1/4 right-1/4 h-[4rpx] bg-[var(--store-bg-one)] rounded-full"
                ></view>
              </view>
            </view>
...
import { getHelpData } from '@/addon/home_service/store/api/member'
...
const redirectToProblemDetail = (helpId: number) => {
 redirect({
        url: '/addon/home_service/store/pages/member/help/detail',
        param: { helpId: helpId }
    })
}
