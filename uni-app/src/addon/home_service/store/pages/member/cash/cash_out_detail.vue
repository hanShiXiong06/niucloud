		...
		<template v-if="!loading">
			...
			<view
				...
				<button
					...
					@click="cashOutCancel"
					v-if="cashOutInfo.status == 1 || cashOutInfo.status == 2 || cashOutInfo.status == 4">{{ t('cashOutCancel') }}</button>
				<button
...
<script lang="ts" setup>
	...
	import { getCashOutDetail, getCashOutTransfer, memberCancel } from '@/addon/home_service/store/api/member';
