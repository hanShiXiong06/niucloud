        ...
        <view class="flex justify-between">
            ...
            <view class="w-[340rpx] h-[504rpx] flex flex-col bg-[#fff] box-border overflow-hidden" :style="goodsTempCss" @click="toLink(goodsList[0])">
                <view :style="goodsImgCss" class="w-[346rpx] h-[350rpx] overflow-hidden">
                    <up-image width="346rpx" height="350rpx" :src="img(goodsList[0].goods_cover_thumb_mid || '')" :mode="diyComponent.mode">
                        <template #error>
                ...
                <view class="px-[16rpx] flex-1 pt-[16rpx] pb-[20rpx] flex flex-col justify-between">
                    ...
                    <view class="flex justify-between flex-wrap items-baseline mt-[28rpx]">
                        <view class="flex items-center">
							...
							<image v-if="diyGoods.priceType(goodsList[0]) == 'member_price'" class="max-w-[50rpx] h-[28rpx] ml-[6rpx]" :src="img('addon/phone_shop/VIP.png')" mode="heightFix" />
							<image v-else-if="diyGoods.priceType(goodsList[0]) == 'newcomer_price'"  class="max-w-[60rpx] h-[28rpx] ml-[6rpx]" :src="img('addon/phone_shop/newcomer.png')" mode="heightFix" />
							<image v-else-if="diyGoods.priceType(goodsList[0]) == 'discount_price'" class="max-w-[80rpx] h-[28rpx] ml-[6rpx]" :src="img('addon/phone_shop/discount.png')" mode="heightFix" />
                        </view>
