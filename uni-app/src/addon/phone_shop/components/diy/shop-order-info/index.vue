        ...
        <view class="diy-text relative">
            <view class="px-[var(--pad-sidebar-m)] pt-[var(--pad-top-m)] pb-[40rpx] flex items-center justify-between">
                ...
                <view class="flex items-center">
                    <view @click="redirect({ url: '/addon/phone_shop/pages/order/list'})" class="flex items-center">
        ...
        <view class="pb-[var(--pad-top-m)] px-[var(--pad-sidebar-m)] flex items-center justify-between text-center">
            <view class="flex flex-col items-center w-[20%] flex-shrink-0" @click="toList(1)">
                <view class="relative w-[44rpx] h-[44rpx]">
                    <image class="w-[44rpx] h-[44rpx]" :src="img('addon/phone_shop/diy/member/order1.png')" />
            ...
            <view class="flex flex-col items-center w-[20%] flex-shrink-0" @click="toList(2)">
                <view class="relative w-[44rpx] h-[44rpx]">
                    <image class="w-[44rpx] h-[44rpx]" :src="img('addon/phone_shop/diy/member/order2.png')" />
            ...
            <view class="flex flex-col items-center w-[20%] flex-shrink-0" @click="toList(3)">
                <view class="relative w-[44rpx] h-[44rpx]">
                    <image class="w-[44rpx] h-[44rpx]" :src="img('addon/phone_shop/diy/member/order3.png')" />
            ...
            <view class="flex flex-col items-center w-[20%] flex-shrink-0" @click="toList(5)">
                <view class="relative w-[44rpx] h-[44rpx]">
                    <image class="w-[44rpx] h-[44rpx]" :src="img('addon/phone_shop/diy/member/order4.png')" />
            ...
            <view class="flex flex-col items-center w-[20%] flex-shrink-0" @click="redirect({ url: '/addon/phone_shop/pages/refund/list'})">
                <view class="relative w-[44rpx] h-[44rpx]">
                    <image class="w-[44rpx] h-[44rpx]" :src="img('addon/phone_shop/diy/member/order5.png')" />
...
import { getShopOrderNum } from '@/addon/phone_shop/api/order';
...
const toList = (status: any) => {
    redirect({ url: '/addon/phone_shop/pages/order/list', param: { status } })
}
</script>
