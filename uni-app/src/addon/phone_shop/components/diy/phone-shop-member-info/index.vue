    ...
    <view :style="warpCss">
        <view class="px-[30rpx] pt-[30rpx] box-border pb-[30rpx]" :class="{'!pb-[120rpx]':diyComponent.isShowAccount}">
            ...
            <view class="flex mt-[40rpx] items-center" v-if="diyComponent.isShowAccount">
                ...
                <view class="text-center w-[33.333%] flex-shrink-0" @click="redirect({ url: '/addon/phone_shop/pages/member/my_coupon' })">
                    <view class="text-[36rpx] mb-[20rpx] font-500 price-font">
...
import { getMyCouponCount } from '@/addon/phone_shop/api/coupon'
...
const toLogin = () => {
    ...
    if (isWeixinBrowser()) {
        ...
        if (normalLogin && authRegisterLogin) {
            ...
            useLogin().setLoginBack({ url: '/addon/phone_shop/pages/member/index' })
