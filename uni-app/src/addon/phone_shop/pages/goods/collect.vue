                                        ...
                                        <view class="flex px-[var(--pad-sidebar-m)]">
                                            ...
                                            <view  class="flex flex-1" @click="toDetail(item)">
                                                <view class="relative w-[200rpx] h-[200rpx] flex items-center justify-center rounded-[var(--goods-rounded-big)] overflow-hidden">
                                                    <up-image radius="var(--goods-rounded-big)" width="200rpx" height="200rpx" :src="img(item.goods_cover_thumb_mid||'')" model="aspectFill">
                                                        <template #error>
                                                ...
                                                <view class="flex flex-1 flex-wrap ml-[20rpx]">
                                                    ...
                                                    <view class="flex justify-between items-end self-end mt-[10rpx] w-[100%]">
                                                        <view class="text-[var(--price-text-color)] price-font truncate max-w-[200rpx]">
                                                            ...
                                                            <image v-if="item.show_type == 'member_price'" class="max-w-[50rpx] h-[28rpx] ml-[6rpx]" :src="img('addon/phone_shop/VIP.png')" mode="heightFix" />
                                                            <image v-else-if="item.show_type  == 'newcomer_price'" class="max-w-[60rpx] h-[28rpx] ml-[6rpx]" :src="img('addon/phone_shop/newcomer.png')" mode="heightFix" />
                                                            <image v-else-if="item.show_type  == 'discount_price'" class="max-w-[80rpx] h-[28rpx] ml-[6rpx]" :src="img('addon/phone_shop/discount.png')" mode="heightFix" />
                                                        </view>
                                                    </view>
                                                </view>
                                            </view>
...
import { getCollectList, cancelCollect } from '@/addon/phone_shop/api/goods';
