...
<!--                                    :image-src="item.goods_cover_thumb_small" />-->
                        ...
                        <view class="px-[16rpx] flex-1 pt-[10rpx] pb-[20rpx] flex flex-col justify-between">
						 ...
						 <view v-if="item.goods_label && item.goods_label.length" class="flex flex-wrap">
                            ...
                            <view class="flex justify-between flex-wrap items-center mt-[16rpx] gap-[10rpx]">
                                <view class="flex items-baseline">
                                    ...
                                    <view class="inline-block price-font text-[24rpx] leading-[1] text-[var(--price-text-color)]">
...
import { getExchangeGoodsList } from '@/addon/phone_shop/api/point';
...
const toDetail = (id: string | number) => {
    redirect({ url: '/addon/phone_shop/pages/point/detail', param: { id: id }, mode: 'navigateTo' })
}
onMounted(() => {
    setTimeout(() => {
