<template>
        ...
        <view class="base-layout-one" v-if="diyGlobal.completeLayout == 'style-1'">
            <view class="detail-one-content">
                ...
                <view class="detail-one-content-value">
                    ...
                    <text v-if="diyComponent.field.privacyProtection" class="ml-[20rpx] text-[var(--primary-color)]"
                          @click="viewPrivacy">{{ t('diyForm.view') }}
                    </text>
                </view>
            </view>
        </view>
    ...
    <view v-else :style="warpCss" class="form-item-frame">
        <view class="base-layout-one" v-if="diyGlobal.completeLayout == 'style-1'">
            ...
            <input type="idcard" class="layout-one-content" :placeholder="inputPlaceholder"
                   ...
                   v-model="diyComponent.field.value" :disabled="isDisabled" maxlength="18" />
        ...
        <view class="base-layout-two" v-if="diyGlobal.completeLayout == 'style-2'">
            ...
            <view class="layout-two-wrap" :class="{'no-border': !diyGlobal.borderControl}">
                ...
                <input type="idcard" class="layout-two-content no-flex" :placeholder="inputPlaceholder"
